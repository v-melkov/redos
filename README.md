...
Средства - Модули - Автоматический приём - Настроить модуль - Путь для сохранения файлов (/home/имя_пользователя/Документы), снять галочку Избегайте имён файлов. Дальше необходимо на каждом пользователе, от которого хочешь принимать файлы автоматически, щёлкнуть правой клавишей - Автоматический прием файлов - Принять автоматически  
